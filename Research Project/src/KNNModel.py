...
for i in range(1,100):
    ...
    log_loss_value = log_loss(y_test, y_prob_knn)
    print(f'Log Loss: {log_loss_value:.4f}')

    results_file = '/Users/adrian/Documents/Research Project/KNNData.csv'
    with open(results_file, 'a') as f:
        f.write(f'{accuracy_score(y_test,y_preds_knn)*100:.4f},{log_loss_value:.4f}\n')
